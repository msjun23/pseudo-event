...
class Event2VocabEncoder(nn.Module):
    def __init__(self, vocab_size=50277):
        ...
        # Assuming the input size is 480x640, downsample to 20x30 using a convolutional approach
        ...
        self.conv = nn.Sequential(
            ...
            nn.ReLU(),
            layer.Conv2d(128, 8, kernel_size=3, stride=2, padding=1, step_mode='m'),
        )
...
class Vocab2EventDecoder(nn.Module):
    def __init__(self):
        ...
        # Decoder to reconstruct the image back to 480x640
