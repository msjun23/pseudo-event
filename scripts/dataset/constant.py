DATA_SPLIT = {
    ...
    # 'validatian': ['Select some scenes from train set', 
    #                'Remove selected scenes from train set'], 
    ...
    # Smallest scenes to test whole process: 
    # {train, validation, test} is working well.
